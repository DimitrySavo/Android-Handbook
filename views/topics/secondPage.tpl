<p>
    Для разработки приложений на языке Kotlin можно использовать такую среду разработки как <span class="b">IntelliJ IDEA</span> от компании JetBrains. 
Загрузить ее можно по адресу 
<a href="https://www.jetbrains.com/idea/download/" rel="nofollow">https://www.jetbrains.com/idea/download/</a>. Данная среда 
...
<p>
    ...
    <a href="https://metanit.com/kotlin/tutorial/1.2.php" rel="nofollow">
        Metanit
    </a>
</p>